   ...
   <!-- <section id="team" class="team">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
                    <div  align="center">
                        <img  style="width: 100%; height: 100%;" src="img/works/item-9.jpg"  >
               <figcaption class="overlay">
                ...
                <div class="col-md-5 text-center wow fadeInRight animated" data-wow-duration="500ms">
                    <br>
                    <h4>Gestionamos la Ejecución de Proyectos Digitales de empresas/organizaciones que comiencen y/o transiten su proceso de Transformación Digital.</h4>
                    <br>
                    <br>
                    <h4>Entendemos la Revolución Digital, la Disrupción Tecnológica y los objetivos de negocios de las marcas por eso colaboramos en su camino de Innovación.</h4>
                    <br>
                </div>
    ...
    <section  class="section about bg-gray" id="about">
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-sm-12 wow fadeInLeft" data-wow-delay="0.3s">
                    <div class="about-slider">
                        <img style="width: 100%; height: 100%;"  src="img/works/item-9.jpg"  alt="">
                ...
                <div class="col-md-5 col-sm-12 wow fadeInLeft">
                    <div class="content">
                        <div class="sub-heading">
                            <h3>Gestionamos la Ejecución de Proyectos Digitales de empresas/organizaciones que comiencen y/o transiten su proceso de Transformación Digital.</h3>
                        </div>
                        <p>
                            Entendemos la Revolución Digital, la Disrupción Tecnológica y los objetivos de negocios de las marcas por eso colaboramos en su camino de Innovación
                        </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-sm-12 wow fadeInLeft">
                    <div class="content">
                        <div class="sub-heading">
                            <h3>Experiencia y entendimiento en Mercadeo, Plataformas Digitales, Tecnología, y Cierres de ventas que asegura el correcto manejo y procesamiento de inversión y datos de resultados de cada uno de nuestros clientes.</h3>
                        </div>
                ...
                <div class="col-md-5 col-sm-12 wow fadeInLeft" data-wow-delay="0.3s">
                    <div class="about-slider">
                        <img style="width: 100%; height: 100%;" src="img/about/1.jpg" alt="">
    ...
    <section id="service" class="service section">
        <div class="container">
            <div class="row">
                <div class="heading wow fadeInUp text-center" >
